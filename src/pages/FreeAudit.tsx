  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      toast({
        ...
        description: "Our team will analyze your website and get back to you within 48 hours.",
      });
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }}>
              ...
              <h1 className="font-heading text-4xl md:text-5xl font-bold text-on-dark mb-6">
                Get Your Free SEO & Marketing Audit
              </h1>
              <p className="text-on-dark-muted text-lg mb-8">
                Discover exactly what's holding your website back and get a custom roadmap to 10x your online growth.
              </p>
              <ul className="space-y-3">
                {[
                  ...
                  <li key={item} className="flex items-center gap-3 text-on-dark">
            ...
            <motion.div initial={{ opacity: 0, x: 30 }} animate={{ opacity: 1, x: 0 }} transition={{ delay: 0.2 }}>
              <form
                ...
                className="p-8 rounded-2xl bg-[hsl(var(--navy)/0.7)] border border-[hsl(var(--navy-light)/0.3)] backdrop-blur-sm space-y-4"
              >
